...
jQuery(document).ready(function ($) {
  ...
  'Novicentro zona 5',
  'Plaza asuncion zona 5',
  'Colonia chacara zona 5 capital',
  'Colonia asuncion zona 5 capital',
  'Torre asuncion sur zona 5 capital',
  'Colonia Providencia zona 5 capital ',
  'Barrio arrivillaga zona 5 capital',
  'Parque navidad zona 5 capital',
  'Casa del niño zona 5 capital',
  'Mercado la palmita zona 5',
  'Colonia san pedrito zona 5',
  'Colonia vivibien zona 5',
  'Colonia santa ana zona 5',
  'Colonia la palmita zona 5 capital',
  'Colonia abril zona 5 capital',
  'Colonia saravia zona 5 capital',
  'Condominio jardinez del centro zona 5',
  'Colonia ferrocarrilera zona 5 capital',
  'Colonia monja blanca zona 5 capital',
  'Colonia la labor zona 5 capital',
  'Colonia la fuente zona 5 capital',
  'Colonia lourdes zona 16',
  'Aldea acatan zona 16',
  'Colonia santa rosita zona 16',
  'Residenciales valles de acatan zona 16',
  'Condominio jardines de maribel',
  'Acacias de cayala zona 16',
  'Portal de cayala zona 16',
  'Acantos de cayala zona 16',
  'Hacienda real zona 16',
  'Lotificacion san isidro zona 16',
  'San gaspar zona 16',
  'Ciudad vieja 1 y 2 zona 16',
  'Residenciales san carlos zona 16',
  'Colonia montesano zona 16 c',
  'Alcazar de santa amelia zona 16',
  'Residenciales puerta de hierro zona 16',
  'San isidro zona 16',
  'Condominio jardines de san isidro zona 16',
  'Ensenada de san isidro zona 16',
  'Residenciales vista hermosa 4 zona 16',
  'Colonia trinidad zona 15',
  'Colonia tecun human zona 15',
  'Vista hermosa zona 15',
  'Condominio lomas del refugio zona 15',
  'Vistas de hacienda real zona 15',
  'Valles de vista hermosa zona 15',
  'Colonia covias zona 5',
  'Colonia lomas de eden zona 5',
  'Colonia la limonada',
  'Colonia el esfuerzo zona 5',
  'Colonia santo domingo zona 5',
  'Colonia el tuerto zona 5',
  'Colonia 15 de agosto zona 5',
  // San Juan 24829
  'Colonia monserrat 2 zona 7 de mixco',
  'Colonia san angel zona 7 de mixco',
  'Residenciales el paraiso 2 zona 7 de mixco',
  'La brigada zona 7 de mixco',
  'Colonia pablo sexto zona 7 de mixco',
  'Colonia belen zona 7 de mixco ',
  'Belencito',
  'Condominio juan pablo zona 6 de mixco',
  'Condominio vistas del encinal zona 6 de mixco',
  'Residenciales bugambilias de san francisco zona 6 de mixco',
  'Alamedas de yumar 1 y 2 zona 6 de mixco',
  'San francisco 1 y 2 zona 6 de mixco',
  'Colonia san jose los pinos zona 6 de mixco',
  'Colonia villa flor zona 6 de mixco',
  'Residenciales villa fernanda 1 y 2 zona 6 de mixco',
  'Lomas de san francisco zona 6 de mixco',
  'Colonia las brisas zona 6 de mixco',
  'La pinada zona 6 de mixco',
  'Colonia san Jorge yumar zona 6 de mixco',
  'Naranjito zona 6 de mixco',
  'Villas del cántaro zona 6 de mixco ',
  'Colonia 10 de mayo zona 6 de mixco',
  'Complejo Industrial mixco norte zona 6 de mixco',
  'san jose las rosas zona 6 de mixco',
  'Col 1ero de julio zona 5 de mixco ',
  'Colonia santa marta zona 5 de mixco ',
  'Condominio alta villa naranjo zona 11 de mixco ',
  'Valles de minerva',
  'Planes de minerva zona 11 de mixco ',
  'Colinas de minerva zona 11 de mixco ',
  'Condado de minerva zona 11 de mixco ',
  'Jardines de minerva 1 y 2 zona 11 de mixco ',
  'colonia 1ero de mayo zona 11 de mixco',
  'Residenciales el valle zona 11 de mixco ',
  'Fuentes de minerva zona 11 de mixco ',
  'Colonia villas de minerva zona 11 de mixco',
  'Condominio valle nuevo 1 y 2 zona 11 de mixco ',
  'Colonia metropolitana zona 11 de mixco',
  'villas de minerva zona 11 de mixco',
  'Real minerva zona 11 de mixco',
  'Lo de fuentes zona 11 de mixco',
  'Montañas de Minerva zona 11 de mixco',
  'Tierra nueva zona 11 de mixco',
  'Colonia Montserrat Real 1',
  'Col Monte Verde',
  'Colonia Monte Real',
  'Condominio La fontana',
  'Colonia monte verde zona 4 de mixco',
  'La Fontana 2',
  'Monte Real 2',
  'Bosques de la Fontana',
  'Condado San Nicolas 2',
  'Condado San Nicolas 3',
  'Colonia San Angel',
  'vistas del mirador ',
  'las minas ',
  'Carolingia ',
  'El milagro',
  'El caminero',
  'Lo de bran zona 6 de mixco',
  'Villa linda 1,2 y 3 zona 7 capital',
  'Condominio santa natalia zona 4 de mixco',
  'Villas coruña zona 4 de mixco',
  'Apartamentos serena zona 4 de mixco',
  'Condominio santa laura zona 4 de mixco',
  'Santa gabriela zona 4 de mixco',
  'Condado san fermin zona 4 de mixco',
  'Condado santa elena zona 4 de mixco',
  'Condominio san fermin zona 4 de mixco',
  'Condominio san daniel zona 4 de mixco',
  'Condado naranjo zona 4 de mixco',
  'Condominio san basilio zona 4 de mixco',
  'Condominio santa irene zona 4 de mixco',
  'Elara residenciales zona 4 de mixco',
  'Villas de oviedo zona 4 de mixco',
  'Casa merida zona 4 de mixco',
  'San esteban zona 4 de mixco',
  'Apartamentos alegria zona 4 de mixco',
  'Alegria torres 3,4,5 y 6 zona 4 de mixco',
  'Villas de cadaques zona 4 de mixco',
  'Villas de bibao zona 4 de mixco',
  'Edificio villas de alicante zona 4 de mixco',
  'Maderia 1 y 2 zona 4 de mixco',
  'El pedregal del naranjo',
  'Finca el naranjo zona 4 de mixco',
  'Parque industrial las tunas zona 4 de mixco',
  'Ofibodegas internanranjo zona 4 de mixco',
  'Bodega comercial el angel zona 4 de mixco',
  'Casa villas magen zona 4 de mixco',
  'Bodega naranjo zona 4 de mixco',
  'Universidad panamericana zona 4 de mixco',
  'Apartamentos torre solento zona 4 de mixco',
  'Lotificacion san nicolas zona 4 de mixco',
  'Bosques de san nicolas zona 4 de mixco',
  'Plaza san san nicolas zona 4 de mixco',
  'Altura san nicolas zona 4 de mixco',
  'Barrio san nicolas 2 zona 4 de mixco',
  'Condominio barrio san nicolas 1 zona 4 de mixco',
  'Bosques de la fontana zona 4 de mixco',
  'Condominio valles del naranjo zona 4 de mixco',
  'Vistas del naranjo 2 zona 4 de mixco',
  'La reserva del naranjo zona 4 de mixco',
  'Suma naranjo zona 4 de mixco',
  'Complejo empresarial flori 2 zona 4 de mixco',
  'Pedregal del naranjo zona 4 de mixco',
  'Villas del rosario zona 4 de mixco',
  'Villas de san jose zona 4 de mixco',
  'Jardines de tulam tzu zona 4 de mixco',
  // San Cristobal 3068
  'Lomas de portugal ',
  ...
  'Ministerio de la defensa zona 9 capital',
  'Guardia de honor zona 9 capital',
  'Canella zona 9 capital',
  'Torre SAT zona 9 capital',
  'Plaza españa zona 9 capital',
  'Plaza uno zona 9 capital',
  'Parque de la Industria zona 9 capital',
  'sixtino zona 10 capital',
  'Hospital herrera geraldi zona 10 capital',
  'Colonia ocklan zona 10 capital',
  'Cañadas de oakland zona 10 capital',
  'Edificio ibero plaza zona 10 capital',
  'Ladera de florencia zona 10 capital',
  'Joyas de florencia zona 10 capital',
  'Galerias la pradera zona 10 capital',
  'Carretera al salvador hasta el km 9.5',
  'Condominio el refugio zona 14 capital',
  'Condado la villa zona 14 capital',
  'Las azaleas zona 14 capital',
  'Instalaciones modernas zona 14 capital',
  'Residenciales el acuerdo zona 14 capital',
  'Universidad san pablo zona 14 capital',
  'Club la villa zona 14 capital',
  'Garces de la villa zona 14 capital',
  'El jardin de la villa zona 14 capital',
  'Morada del acueducto zona 14 capital',
  'Condominio piemonte zona 14 capital',
  'Aoki apartamentos zona 14 capital',
  'Apartamento real de los fiallos zona 14 capital',
  'Condominio residenciales villas de antari zona 14 capital',
  'Rincones de antigua zona 14 capital',
  'residenciales las montañas zona 14 capital',
  'Apartamentos villa catorce zona 14 capital',
  'Condominio las mercedes zona 14 capital',
  'Edificio torreon zona 14 capital',
  'La cañada zona 14 capital',
  'Colonia las conchas zona 14 capital',
  'Residenciales duare zona 14 capital',
  'Canton victoria zona 14 capital',
  'Colonia campo 1 zona 14 capital',
  'Colonia bella aurora zona 14 capital',
  'Colonia san jose los arcos zona 14 capital',
  'Colonia la cañada zona 14 capital',
  'Emisoras unidas zona 13 capital',
  'Viveros la paz zona 13 capital',
  'Colonia plaza toros zona 13 capital',
  'Condominio valle verde zona 13 capital',
  'Condominio panoramica zona 13 capital',
  'Condominio elgin zona 13 capital',
  'Colonia eligin 2 zona 13 capital',
  'Colonia la aurora zona 13 capital',
  'Colonia lomas de pamplona zona 13 capital',
  'Cañadas de elgin zona 13 capital',
  'Colonia la libertad zona 13 capital',
  'Colonia ReIna barrios 2 zona 13 capital',
  'Colonia nueva aurora zona 13 capital',
  // Metronorte 2243
  ...
  let gtgu_opciones_2 = [
    '',
    // Xela 2250 (Quetzaltenango)
    'Colonia el cervecero zona 1 de xela',
    'Barrio el calvario zona 1 de xela',
    'Colonia villas del calvario zona 1 de xela',
    'Zona 2 de xela (completa)',
    'Colonia el rosario zona 3 de xela',
    'Residenciales la democracia zona 3 de xela',
    'Condominio condado santa maria zona 3 de xela',
    'Condominio el tinajon zona 3 de xela',
    'Condominio maria jose zona 3 de xela',
    'Colonia minerva zona 3 de xela',
    'Villas las cabañas zona 3 de xela',
    'Condominio san joaquin zona 3 de xela',
    'Apartamentos divitia zona 3 de xela',
    'Templo de minerva zona 3 de xela',
    'Colonia Primavera 1 y 2 zona 4 de xela',
    'Condominio villa cecilia zona 5 de xela',
    'Condominio villa zarca zona 5 de xela',
    'Colonia las rosas zona 5 de xela',
    'Colonia molina zona 5 de xela',
    'Lotificacion efrain bamaca zona 5 de xela',
    'Lotificiacion loma linda zona 5 de xela',
    'Colonia los alamos zona 5 de xela',
    'Condominio las orquiedeas zona 5 de xela',
    'Condominio villa cecilia zona 5 de xela',
    'Colonia labor los molinos zona 5 de xela',
    'Residenciales loma linda zona 5 de xela',
    'Condominio las calas zona 5 de xela',
    'Residenciales las calas zona 5 de xela',
    'Colonia labor las vegas zona 5 de xela',
    'Condominio villa cecilia zona 5 de xela',
    'Condominio la perla 1 y 2 zona 6 de xela',
    'residenciales valle del rosario zona 6 de xela',
    'Condominio los saucos zona 6 de xela',
    'Colonia santa izabel zona 6 de xela',
    'Condominio jardin de la villa zona 6 de xela',
    'Residenciales el leon zona 6 de xela',
    'residenciales valle del rosario zona 6 de xela',
    'Colonia claris zona 6 de xela',
    'Condominio bella aurora zona 6 de xela',
    'Residenciales bella aurora zona 6 de xela',
    'Residenciales villas de jazmin zona 6 de xela',
    'Paseo la arboleda zona 7 de xela',
    'Lotificacion rabanales zona 7 de xela',
    'Llanos de la cruz zona 7 de xela',
    'Condominio Pradera 1 y 2 zona 7 de xela',
    'Condominio de castilla 1 y 2 zona 7 de xela',
    'Condominio villas del campo 1 y 2 zona 7 de xela',
    'Condominio villa claudia zona 7 de xela',
    'Condominio san jorge zona 7 de xela',
    'Condominio prados de santa maria zona 7 de xela',
    'Condominio villas del pilar zona 7 de xela',
    'Villa don pablo zona 7 de xela',
    'Lotificacion cedros del libano zona 7 de xela',
    'Condominio villa de fatima zona 7 de xela',
    'Condominio pinar del rio zona 7 de xela',
    'Colonia jardines de xelaju zona 7 de xela',
    'Lotificacion ever zona 7 de xela',
    'Condominio los manzanos zona 7 de xela',
    'Colonia san antonio zona 7 de xela',
    'Colonia san rafael zona 7 de xela',
    'Condominio villa fatima zona 7 de xela',
    'Condominio los arcos zona 7 de xela',
    'Colonia los trigales zona 7 de xela',
    'Colonia panorama zona 7 de xela',
    'Colonia ceres zona 7 de xela',
    'Residenciales el sol zona 8 de xela',
    'Condominio santa monica zona 8 de xela',
    'Condominio villa morelia zona 8 de xela',
    'Condominio villa alejandra zona 8 de xela',
    'Condominio santa virginia zona 8 de xela',
    'Condominio santa rita zona 8 de xela',
    'Condominio los pinos zona 8 de xela',
    'Colonia las tapias zona 8 de xela',
    'Residenciales alta villa zona 9 de xela',
    'Avenida las americas zona 9 de xela ',
    'Condominio planes del pedregal zona 10 de xela',
    'Condominio santa maria del pinal zona 10 de xela',
    'Colonia el pedregal zona 10 de xela',
    'Colonia pacaja alto zona 10 de xela',
    'Condominio prados de san lucas zona 11 de xela',
    'Colonia lomas de san jose zona 11 de xela',
    'Condominio altos de vista bella zona 11 de xela',
    'Residenciales valle de la rosa zona 11 de xela',
    'Residencial puerta del valle 1 y 2 zona 11 de xela',
    'Residenciales valle de las rosas zona 11 de xela',
    'Colonia vista del valle zona 11 de xela',
    'Condominio residencial king ranch zona 11 de xela',
    'Hacienda King ranch zona 11 de xela',
    'Condominio la rivera zona 11 de xela',
    'Condominio altamira 1,2 y 3 zona 11 de xela',
    'Barrio la cumbre',
    'Prados de salcaja',
    'Condominio san fernando',
    'Llano del pinal',
    // Xela Interplaza 24021 (Quetzaltenango)
    'Condominio villa los cerezos zona 9 de xela',
    'Condominio los cerezos 1 zona 9 de xela',
    'Colonia obras publicas zona 9 de xela',
    'Condominio los cerezos 2 zona 9 de xela',
    'Condominio lomas de la floresta zona 9 de xela',
    'Residenciales la villa zona 9 de xela',
    'Condominio valle verde',
    'Condominio Helvetia',
    'Condominio agapantos zona 8 de xela',
    'Residenciales gardenia de plata zona 8 de xela',
    'Condominio tulipanes zona 9 de xela',
    'Condominio villa floresta zona 9 de xela',
    'Condominio la estancia zona 9 de xela',
    'Colonia altos del valle 2 zona 9 de xela',
    'Condominio Balcones de san mateo',
    'Condominio el silencio xela',
 ...
 //   'san juan ostuncalco',
    ...
    'Condominio la pinada',
    'Condominio santa teresita 1 y 2',
    'Condominio jardines del valle',
    'Condominio difiori',
    'Condominio portan de san javier',
    'Condominio puerta del valle',
    'Colonia pinar del llano',
    'Condominio san miguel y del llano',
    'Condominio angeludi',
    'Condominio monte sion',
    'Condominio villas de san jose',
    'Condominio mediterraneo',
    'Residenciales bella aurora',
    'Colonia el llano',
    'Residenciales la paz',
    'Condominio la perla 1',
    'Condominio villas del campo',
    'Condominio santa ana',
    'Condominio jardines de la cruz',
    'Condominio santa ana',
    'Condominio shalom',
    'Olintepeque',
    'Condominio villas de don victor',
    'Condominio villas soler',
    'Callejon santos',
    'Condominio villa ferrer',
    'Condominio el bosque',
    'Condominio lomas de los alisos',
    'Condominio las ramblas',
    'Colonia bugambilias de la esperanza',
    'Colonia labor san rafael',
    'Colonia el maestro',
    'Condominio villa soler',
    'Residenciales la paz',
    'Apartamentos piamonte',
    'San mateo',
    'Colonia los bomberos zona 8 de xela',
    'Avenida los cerezales zona 8 de xela',
    'Colonia los cerezos zona 9 de xela',
    'Condominio los tulipanes zona 8 de xela',
    'Condominio portal de la floresta zona 8 de xela',
    'Aldea justo rufino barrio quetzaltenango',
    'Aldea siguila',
