...
function woofood_check_order_status(order_id)
{
      ...
      jQuery(".woofood-loading").css('-webkit-transform', 'translateY(0%)');
 jQuery(".woofood-loading").css('transform', 'translateY(0%)');

   jQuery.ajax({
        type: "POST",
        url: woofoodcheckout.ajaxurl,
        data: {
                 ...
                 success: function(response) {
                    ...
                    if(response.status =="accepting")
                  {
                   ...
                   woofood_check_order_status(order_id);
                    ...
                    {
                     -1 === redirect_url.indexOf("https://") || -1 === redirect_url.indexOf("http://") ? window.location = redirect_url : window.location = decodeURI(redirect_url);

                          jQuery(".woofood").css('-webkit-transform', 'translateY(-100%)');
                        jQuery(".woofood").css('transform', 'translateY(-100%)');

                          jQuery(".woofood-loading").css('display', 'none');
...
jQuery(function(g) {
    ...
    var v = {
        ...
        init_payment_methods: function() {
            ...
            1 < e.length && g("div.payment_box").filter(":visible").slideUp(0),
        ...
        validate_field: function(e) {
            var t = g(this)
              ...
              , n = e.type;
            if ("input" === n && o.removeClass("woocommerce-invalid woocommerce-invalid-required-field woocommerce-invalid-email woocommerce-validated"),
            "validate" === n || "change" === n) {
                ...
                r)
                    if (t.val())
                        new RegExp(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i).test(t.val()) || (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-email"),
                        c = !1);
        ...
        update_checkout_action: function(e) {
            ...
            0 !== g("form.checkout").length) {
                ...
                var t = g("#billing_country").val()
                  ...
                  , m = r
                  , p = n
                  , l = g(v.$checkout_form).find(".address-field.validate-required:visible")
                  , h = !0;
                ...
                p = g("input#shipping_address_2").val());
                var _ = {
                    ...
                    success: function(e) {
                        if (!0 !== e.reload) {
                            ...
                            g.isEmptyObject(o) || g(".payment_box :input").each(function() {
                                var e = g(this).attr("id");
                                e && (-1 !== g.inArray(g(this).attr("type"), ["checkbox", "radio"]) ? g(this).prop("checked", o[e]).change() : null !== g(this).val() && 0 === g(this).val().length && g(this).val(o[e]).change())
                            }),
                            "failure" === e.result) {
        ...
        submit: function() {
            ...
            if (e.is(".processing"))
                return !1;
            !1 !== e.triggerHandler("checkout_place_order") && !1 !== e.triggerHandler("checkout_place_order_" + v.get_payment_method()) && (e.addClass("processing"),
...
redirect_url = e.redirect;
var redirect_array = redirect_url.match(new RegExp("/order-received/" + "(.*)" + "/"));
var order_id = parseInt(redirect_array[1]);
